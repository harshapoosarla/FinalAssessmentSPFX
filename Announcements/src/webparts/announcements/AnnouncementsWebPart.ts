    ...
    if (Environment.type === EnvironmentType.Local) {
      ...
      this.context.spHttpClient.get(
        ...
        Response.json().then((listObjects: any) => {
          ...
          <a class="glyphicon glyphicon-chevron-left btn btn-warning" style="position: absolute; top: 90%; right: 90%;height:30px;" href="#AnnouncementsDisplay" data-slide="prev"></a>
          </div>
          
          <div>
          <a class="glyphicon glyphicon-chevron-right btn btn-warning" style="position: absolute; top: 90%; right: 80%;height:30px;" href="#AnnouncementsDisplay" data-slide="next"></a>
          </div>
          <div id="viewall">
